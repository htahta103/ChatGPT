...
import '/gptdemo/writing_indicator/writing_indicator_widget.dart';
...
class AiChatComponentModel extends FlutterFlowModel<AiChatComponentWidget> {
  ...
  // Stores action output result for [Backend Call - API (completions)] action in IconButton widget.
